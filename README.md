...
- [cosmocode/dokuwiki-plugin-photogallery](https://github.com/cosmocode/dokuwiki-plugin-photogallery) -  (today)
- [cosmocode/starred](https://github.com/cosmocode/starred) - allows users to remember pages (3 days ago)
...
- [splitbrain/gotextextract](https://github.com/splitbrain/gotextextract) - Cross Platform text extractor for common office files (5 days ago)
- [michitux/dokuwiki-plugin-searchtext](https://github.com/michitux/dokuwiki-plugin-searchtext) - Searches pages rendered as text instead of raw wiki. Displays search result snippets from text. (6 days ago)
